...
- <details>
  <summary>Example (Pixelsort)</summary>
...
- <details>
  <summary>Example (Chroma Glitch)</summary>
...
- <details>
  <summary>Example (Datamosh)</summary>
...
- pnpm (or npm if you absolutely prefer)
  - Can be installed via: `npm install -g pnpm`
...
See [TESTS.md](/TESTS.md) for coverage details.
